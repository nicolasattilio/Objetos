...
public class Rectangulo {
	...
	public Rectangulo(Punto p1,double d) {
		this.setP1(p1);
		this.setP3(new Punto(p1.getCoorX(),p1.getCoorY()+d));
		this.setP4(new Punto(p1.getCoorX()+d,p1.getCoorY()));
		this.setP2(new Punto(p4.getCoorX(),p3.getCoorY()));
	}
